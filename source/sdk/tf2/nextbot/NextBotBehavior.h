...
public:
	...
	void Update(Actor* me, float interval)
	{
		...
		if (m_action && g_pActionsTools->IsDebugging(me, NEXTBOT_BEHAVIOR))
		{
			// CFmtStr msg;
...
private:
	...
	virtual void OnWeaponFired(CBaseCombatCharacter* whoFired, CBaseCombatWeapon* weapon) override { PROCESS_EVENT_WITH_2_ARGS(OnWeaponFired, whoFired, weapon); }
...
{
	// debug display
	behavior::Debug(me, this, behavior, " STARTING ");
...
void Action< Actor >::InvokeOnEnd(Actor* me, Behavior< Actor >* behavior, Action< Actor >* nextAction)
{
	...
	behavior::Debug(me, this, behavior, " ENDING ");
...
{
	behavior::Debug(me, this, behavior, " SUSPENDING ");
...
{
	behavior::Debug(me, this, behavior, " RESUMING ");
...
Action< Actor >* Action< Actor >::ApplyResult(Actor* me, Behavior< Actor >* behavior, ActionResult< Actor > result)
{
	...
	case CHANGE_TO:
	{
		...
		behavior::ApplyResult_Debug_ChangeTo(me, this, newAction, behavior, result);
		...
		// debug display
		if (g_pActionsTools->IsDebugging(me, NEXTBOT_BEHAVIOR))
		{
	...
	case SUSPEND_FOR:
	{
		...
		// debug display
		behavior::ApplyResult_Debug_SuspendFor(me, this, newAction, topAction, behavior, result);
	...
	case DONE:
	{
		...
		// debug display
		behavior::ApplyResult_Debug_Done(me, this, newAction, resumedAction, behavior, result);
