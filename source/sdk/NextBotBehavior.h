...
public:
	...
	virtual EventDesiredResult< Actor > OnSpokeConcept(Actor* me, CBaseCombatCharacter* who, AIConcept_t aiconcept, AI_Response* response, void* unknown) { return TryContinue(); }
...
#define PROCESS_EVENT( METHOD )							\
		{													\
			...
			while( _action )								\
			{												\
				ActionDebugMsg(m_behavior, _action, m_actor, #METHOD); \
			...
			if ( _action )									\
			{												\
				ActionDebugMsg(m_behavior, _action, m_actor, #METHOD, _result); \
...
{
	INextBot* nextbot = GetEntityNextbotPointer(me);

	if (nextbot->IsDebugging(NEXTBOT_BEHAVIOR) || (NextBotDebugHistory && NextBotDebugHistory->GetBool()))
	{
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 150, 255), "%3.2f: %s:%s: ", gpGlobals->curtime, nextbot->GetDebugIdentifier(), behavior->GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(0, 255, 0, 255), " STARTING ");
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), "\n");
	}
...
void Action< Actor >::InvokeOnEnd(Actor* me, Behavior< Actor >* behavior, Action< Actor >* nextAction)
{
	...
	{
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 150, 255), "%3.2f: %s:%s: ", gpGlobals->curtime, nextbot->GetDebugIdentifier(), behavior->GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 0, 255), " ENDING ");
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), "\n");
	}
...
Action< Actor >* Action< Actor >::InvokeOnSuspend(Actor* me, Behavior< Actor >* behavior, Action< Actor >* interruptingAction)
{
	...
	{
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 150, 255), "%3.2f: %s:%s: ", gpGlobals->curtime, nextbot->GetDebugIdentifier(), behavior->GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 255, 255), " SUSPENDING ");
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), "\n");
	}
...
ActionResult< Actor > Action< Actor >::InvokeOnResume(Actor* me, Behavior< Actor >* behavior, Action< Actor >* interruptingAction)
{
	...
	{
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 150, 255), "%3.2f: %s:%s: ", gpGlobals->curtime, nextbot->GetDebugIdentifier(), behavior->GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 255, 255), " RESUMING ");
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), GetName());
		nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), "\n");
	}
...
Action< Actor >* Action< Actor >::ApplyResult(Actor* me, Behavior< Actor >* behavior, ActionResult< Actor > result)
{
	...
	case CHANGE_TO:
	{
		...
		if (nextbot->IsDebugging(NEXTBOT_BEHAVIOR) || NextBotDebugHistory->GetBool())
		{
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 150, 255), "%3.2f: %s:%s: ", gpGlobals->curtime, nextbot->GetDebugIdentifier(), behavior->GetName());

			if (this == newAction)
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 0, 255), "START ");
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), newAction->GetName());
			}
			else
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), this->GetName());
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 0, 255), " CHANGE_TO ");
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), newAction->GetName());
			}

			if (result.m_reason)
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(150, 255, 150, 255), "  (%s)\n", result.m_reason);
			}
			else
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), "\n");
		...
		if (nextbot->IsDebugging(NEXTBOT_BEHAVIOR))
		{
	...
	case SUSPEND_FOR:
	{
		...
		if (nextbot->IsDebugging(NEXTBOT_BEHAVIOR) || NextBotDebugHistory->GetBool())
		{
			...
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), this->GetName());
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 255, 255), " caused ");
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), topAction->GetName());
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 0, 255, 255), " to SUSPEND_FOR ");
			nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), newAction->GetName());
	...
	case DONE:
	{
		...
		if (nextbot->IsDebugging(NEXTBOT_BEHAVIOR) || NextBotDebugHistory->GetBool())
		{
			...
			if (resumedAction)
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(0, 255, 0, 255), " DONE, RESUME ");
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(255, 255, 255, 255), resumedAction->GetName());
			}
			else
			{
				nextbot->DebugConColorMsg(NEXTBOT_BEHAVIOR, Color(0, 255, 0, 255), " DONE.");
			}
