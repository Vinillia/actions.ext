...
public:
	...
	virtual EventDesiredResult< CBaseEntity > OnSpokeConcept(CBaseEntity* me, CBaseCombatCharacter* who, AIConcept_t aiconcept, AI_Response* response)  override;
	virtual EventDesiredResult< CBaseEntity > OnWeaponFired(CBaseEntity* me, CBaseCombatCharacter* whoFired, CBaseCombatWeapon* weapon) override;
	...
	virtual EventDesiredResult< CBaseEntity > OnActorEmoted(CBaseEntity* me, CBaseCombatCharacter* emoter, int emote)  override;
	...
	virtual EventDesiredResult< CBaseEntity > OnTerritoryContested(CBaseEntity* me, int territoryID) override;
	virtual EventDesiredResult< CBaseEntity > OnTerritoryCaptured(CBaseEntity* me, int territoryID) override;
	virtual EventDesiredResult< CBaseEntity > OnTerritoryLost(CBaseEntity* me, int territoryID) override;
	virtual EventDesiredResult< CBaseEntity > OnWin(CBaseEntity* me) override;
	virtual EventDesiredResult< CBaseEntity > OnLose(CBaseEntity* me) override;
...
public:
	...
	virtual const CKnownEntity* SelectMoreDangerousThreat(const INextBot* me,
		...
		const CKnownEntity* threat2) const override;
};
