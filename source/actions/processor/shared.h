...
inline decltype(auto) ProcessHandlerEx(const ProcessorFunction& hf, A action, M&& handler, Args&& ...args)
{
...
template<typename M, typename A, typename ...Args>
inline decltype(auto) ProcessHandler(const ProcessorFunction& hf, A action, M&& handler, Args&& ...args)
{
